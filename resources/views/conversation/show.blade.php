...
@section('additional_js')
    ...
    <script>
        var socket = io.connect('http://54.255.246.137:8890');
    ...
    <script>
        ...
        function button_send_msg(){
            var msg = $('#msg').val();
            var mapObj = {
                sex:"[prohibited keywords]",
                nude:"[prohibited keywords]",
                happy:"[prohibited keywords]"
            };
            msg = msg.replace(/sex|nude|happy/gi, function(matched){
